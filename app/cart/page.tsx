...
const CartPage = () => {
    ...
    const { cart, totalAmount, removeFromCart, incrementQuantity, decrementQuantity } = useCartStore()
    return (
                        ...
                        <tbody className="whitespace-nowrap divide-y">
                            {
                                cart.map((item) => {
                                    return <tr key={item.id}>
                                        ...
                                        <td className="py-6 px-4">
                                            <h4 className="text-lg font-bold text-white">${item.stringPrice}</h4>
                                        </td>
                                    </tr>
                                })
                            }
                ...
                <div className=" max-w-xl ml-auto mt-6">
                    <ul className="text-white divide-y">
                        ...
                        <li className="flex flex-wrap gap-4 text-md py-3 font-bold">
                            Total <span className="ml-auto">${totalAmount + 4 + 4}</span>
                        </li>
                    </ul>
                    <Link
                        type="button"
