        ...
        <div className="p-4 w-full">
            <div className="w-full reviews mb-[60px]">
                <div className="w-full comments mb-[60px]">
                    <div className="comment-item  px-10 py-[32px] mb-2.5">
                        <div className="comment-author flex justify-between items-center mb-3">
                            <div className="flex space-x-3 items-center">
                                <div className="w-[50px] h-[50px] rounded-full overflow-hidden">
                                    <img
                                        src="https://png.pngtree.com/png-clipart/20210606/original/pngtree-gray-avatar-placeholder-png-image_6398267.jpg"
                                        alt=""
                        ...
                        <div className="comment mb-[30px]">
                            <p className="text-[15px] text-qgray leading-7 text-normal">
                                ...
                                ever since the redi 1500s, when an unknown printer took a galley of
                ...
                <div className="w-full review-form ">
                            ...
                            <div className="input-com w-full h-full">
                                ...
                                <div className="input-wrapper border border-qgray-border w-full h-full overflow-hidden relative ">
                                    <input
                                        ...
                                        className=" bg-transparent input-field placeholder:text-sm text-sm px-6 text-dark-gray w-full h-full font-normal  focus:ring-0 focus:outline-none h-[50px]"
                                        type="text"
                                        id="name"
                            ...
                            <div className="input-com w-full h-full">
                                ...
                                <div className="input-wrapper border border-qgray-border w-full h-full overflow-hidden relative ">
                                    <input
                                        ...
                                        className="input-field placeholder:text-sm text-sm px-6 text-dark-gray w-full h-full font-normal bg-transparent text-black  focus:ring-0 focus:outline-none h-[50px]"
                                        type="email"
                                        id="name"
                                        defaultValue=""
                                    />
                            ...
                            <div className="input-com w-full h-full">
                                ...
                                <div className="input-wrapper border border-qgray-border w-full h-full overflow-hidden relative ">
                                    <input
                                        ...
                                        className="input-field placeholder:text-sm text-sm px-6  bg-transparent text-black  w-full h-full font-normal  focus:ring-0 focus:outline-none h-[50px]"
                                        type="text"
                                        id="name"
                                        defaultValue=""
                                    />
                    ...
                    <div className="w-full mb-[30px]">
                        ...
                        <textarea
                            ...
                            cols={30}
                            rows={3}
                            className="w-full bg-transparent text-black border focus:ring-0 focus:outline-none p-6"
                            defaultValue={""}
                        />
                    </div>
